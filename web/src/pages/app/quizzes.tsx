...
/**
 * Página de listagem de materiais com quizzes
 *
 * Features:
 * - Lista todos materiais que têm quizzes
 * - Busca por título do material
 * - Navegação para quizzes do material
 * - Layout similar à página de flashcards
 *
 * Rota: /quizzes
 */
    ...
    <div className="container mx-auto py-8 space-y-6">
      ...
      <div className="flex items-center justify-between">
        <div>
          ...
          <p className="text-muted-foreground">
            Selecione um material para responder seus quizzes
          </p>
        </div>
      </div>
      ...
      <Card>
        ...
        <CardContent>
          ...
          <p className="text-xs text-muted-foreground">materiais com quizzes</p>
        </CardContent>
      </Card>
      ...
      {filteredMaterials && filteredMaterials.length > 0 ? (
        ...
        <Card>
          <CardHeader>
            ...
            <CardDescription>
              Crie um material para gerar quizzes automaticamente
            </CardDescription>
          </CardHeader>
          <CardContent>
