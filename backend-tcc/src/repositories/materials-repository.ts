...
export type MaterialsRepository = {
  ...
  createWithContent(data: CreateMaterialWithContent): Promise<{
    ...
    summary: { id: string; content: string; material_id: string; user_id: string; created_at: Date };
    flashcards: Array<{ id: string; question: string; answer: string; user_id: string; material_id: string }>;
    quizzes: Array<{ id: string; question: string; options: unknown; correct_answer: string; material_id: string; user_id: string; created_at: Date }>;
  }>;
